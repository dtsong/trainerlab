...
class TestEngineConfiguration:
    ...
    def test_engine_uses_effective_database_url(
        self, mock_create_engine: MagicMock, mock_settings: MagicMock
    ) -> None:
        """Test that engine is created with effective_database_url."""
        mock_settings.return_value.effective_database_url = (
    ...
    def test_engine_echo_follows_debug_setting(
        ...
        """Test that engine echo is set based on debug setting."""
        mock_settings.return_value.effective_database_url = (
            "postgresql+asyncpg://user:pass@localhost/testdb"
        )
